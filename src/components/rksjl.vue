...
import {rksjl_option as option} from '../config/echarts_api.js'
import { rksjlData } from '../service/getDate.js'
export default {
    data(){
        return {
    ...
    methods:{
        init(){
            let myChart = echarts.init(document.getElementById('rksjl'));
            rksjlData().then((res)=>{
